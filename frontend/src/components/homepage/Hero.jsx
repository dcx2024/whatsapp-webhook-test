  ...
  return (
    ...
    <section className="bg-surface-bright py-25 flex flex-col items-center justify-center px-4">
      ...
      <div className="flex items-center justify-center gap-4 mt-8">
        <button className="text-white bg-primary flex items-center gap-2 px-6 py-3 rounded-lg font-medium hover:opacity-90 transition-opacity" onClick={handleClick}>
